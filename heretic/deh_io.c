...
void DEH_Warning(deh_context_t *context, const char *msg, ...)
{
    ...
    dprintf("%s:%i: warning: ", context->filename, context->linenum);
    dvprintf((char *)msg, args);
    dprintf("\n");
...
void DEH_Error(deh_context_t *context, const char *msg, ...)
{
    ...
    dprintf("%s:%i: ", context->filename, context->linenum);
    dvprintf((char *)msg, args);
    dprintf("\n");
